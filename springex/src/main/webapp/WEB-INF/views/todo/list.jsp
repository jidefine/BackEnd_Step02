...
<%--                            </div>--%>
<%--                            <div class="mb-3">--%>
<%--&lt;%&ndash;                                <input type="checkbox" name="types" value="t" ${pageRequestDTO.checkType("t")?"checked":""}>제목&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <input type="checkbox" name="types" value="w"  ${pageRequestDTO.checkType("w")?"checked":""}>작성자&ndash;%&gt;--%>
